<?php
/**
 * Router for /review/<company-slug>/<form-slug> short links (see the root
 * .htaccess). Resolves the pair to a form's share token and sends the visitor
...
$token  = FormsService::tokenForShortLink((string)($_GET['c'] ?? ''), (string)($_GET['s'] ?? ''));
