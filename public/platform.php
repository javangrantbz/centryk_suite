    ...
    <section id="apps">
        ...
        <div class="mt-5 grid gap-4 sm:grid-cols-2">
            ...
            $apps = [
                ...
                ['Calendar', 'Shared scheduling', 'A company calendar surfaced across the suite, with a drawer preview on every page. Public holidays, staff birthdays and work anniversaries appear automatically, and prompt a notification.'],
