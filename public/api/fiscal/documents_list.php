<?php
/** Belize BTS e-invoicing: list a company's fiscal documents. GET ?company_id=&status= */
...
Response::ok([
    'documents' => FiscalInvoicingService::listDocuments($companyId, ['status' => $_GET['status'] ?? '']),
]);
