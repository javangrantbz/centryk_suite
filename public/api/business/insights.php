<?php
/** Cross-module KPI snapshot for a company. POST { company_id }
 *  Admin/manager of the company, which must hold >=1 package. */
require_once __DIR__ . '/../../../app/core/Auth.php';
require_once __DIR__ . '/../../../app/core/DB.php';
require_once __DIR__ . '/../../../app/core/Response.php';
require_once __DIR__ . '/../../../app/services/BusinessInsights.php';
...
Response::ok(BusinessInsights::forCompany($companyId));
