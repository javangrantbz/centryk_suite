...
$board = [
    ...
    'In progress' => [
        ...
        'items'  => [
            ...
            ['Statement PDF + email delivery (reuse invoice-maker dompdf)', null],
            ['Reminders — actually send the email, not just log it', null],
            ['Billing — generate a real invoice through invoice-maker; dunning cron → past_due', null],
            ['Reconciliation — OFX / MT940 formats, live bank feed adapter', null],
        ],
    ],
    'Planned' => [
        'accent' => 'violet',
        'items'  => [
            ['Routes — mobile/field UI for drivers, route sequencing / maps, per-driver commission', null],
