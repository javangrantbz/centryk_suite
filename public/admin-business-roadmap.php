...
$board = [
    ...
    'In progress' => [
        ...
        'items'  => [
            ...
            ['OnePay reconciliation — subset-sum matching when a settlement covers only part of the batch; card-processor fee handling; OnePay to send settlement_ref + method', null],
    ...
    'Planned' => [
        ...
        'items'  => [
            ...
            ['Belize — public-holiday-aware due dates & route scheduling', null],
