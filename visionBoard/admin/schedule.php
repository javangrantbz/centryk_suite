...
?>
<h1 class="text-xl font-black tracking-tight text-slate-900 mb-3">Schedules</h1>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sticky top-4">
      ...
      <form method="post" class="space-y-3">
        ...
        <div class="flex gap-2 pt-1">
          ...
          <?php if ($editing): ?><a href="schedule.php" class="px-4 py-2 rounded-xl border border-slate-200 text-slate-600 font-semibold hover:bg-slate-50 transition-colors">Cancel</a><?php endif; ?>
        </div>
      </form>
      <?php endif; ?>
    </div>
          ...
          <div>
            ...
            <div class="relative h-96 rounded-lg bg-slate-50 border border-slate-200 overflow-hidden">
              ...
              <?php foreach ($calendarBlocks[$dayNum] as $block): ?>
                <div class="absolute left-1 right-1 rounded-md bg-rose-600/90 text-white px-2 py-1 overflow-hidden shadow-sm"
