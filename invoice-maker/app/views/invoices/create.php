...
<div class="mb-10">
    ...
    <h2 class="text-4xl font-extrabold text-slate-900 tracking-tight">Create Invoice</h2>
</div>
...
<form method="POST" class="space-y-8">
    ...
    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                <label class="block mb-2 text-xs font-bold text-gray-400 uppercase tracking-widest">Invoice Number</label>
                <input name="invoice_number" value="<?= $invoiceNumber ?>" required class="w-full border-gray-100 bg-gray-50/50 rounded-2xl p-3.5 focus:ring-emerald-500 transition-all text-sm font-mono">
            </div>
            ...
            <div>
                <label class="block mb-2 text-xs font-bold text-gray-400 uppercase tracking-widest">Due Date</label>
                <input type="date" name="due_date" class="w-full border-gray-100 bg-gray-50/50 rounded-2xl p-3.5 focus:ring-emerald-500 transition-all text-sm">
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
        <h3 class="text-xl font-bold text-slate-900 mb-6 flex items-center">
            <i data-lucide="list" class="w-5 h-5 mr-3 text-emerald-600"></i>
            Line Items
        </h3>
        ...
        <div id="items-container" class="space-y-4">
            <div class="grid grid-cols-12 gap-4 item-row group">
                <div class="col-span-12 md:col-span-6">
                    <input name="description[]" required placeholder="Item Description" class="w-full border-gray-100 bg-gray-50/50 rounded-xl p-3.5 focus:ring-emerald-500 transition-all text-sm">
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            <label class="block mb-4 text-xs font-bold text-gray-400 uppercase tracking-widest">Internal Notes / Terms</label>
            <textarea name="notes" rows="6" class="w-full border-gray-100 bg-gray-50/50 rounded-2xl p-4 focus:ring-emerald-500 focus:bg-white transition-all text-sm" placeholder="Add any special instructions or terms..."></textarea>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
            <div class="flex justify-between items-center pb-4 border-b border-gray-50">
                <label class="text-xs font-bold text-gray-400 uppercase tracking-widest">Subtotal</label>
            ...
            <div class="bg-[#1a1a1a] p-6 rounded-2xl flex justify-between items-center text-white">
                <span class="text-xs font-bold uppercase tracking-widest opacity-60">Grand Total</span>
    ...
    <div class="flex items-center justify-between pt-10">
        <a href="<?= BASE_URL ?>/?page=invoices" class="text-gray-400 font-bold hover:text-slate-900 transition-colors">Discard</a>
